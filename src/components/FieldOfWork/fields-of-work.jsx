...
export const FieldsOfWork = () => {
  ...
  const showNext = (direction) => {
    ...
    switch (direction) {
      case 'right':
        sliderRef.current.scrollLeft += sliderRefChildWidth
        if (childrenWidth <= sliderRef.current.scrollLeft) {
  ...
  return (
    <div id='services' className="c-fields-of-work-container">
      ...
      <div onClick={() => showNext('right')} className='c-slider-action right'>
      ...
      <div onClick={() => showNext('left')} className='c-slider-action left'>
        <svg xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 -960 960 960" width="48"><path d="m304-82-56-57 343-343-343-343 56-57 400 400L304-82Z" /></svg>
      </div>
