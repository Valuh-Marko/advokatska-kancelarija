...
export const Interns = () => {
  ...
  return (
    <div className="c-interns-container">
      <h2 className="c-interns__title">Naši Pripravnici</h2>
      ...
      <div className="c-interns__wrapper">
        ...
        <div className="c-interns__register">
          ...
          <p className="c-interns__register-desc">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Culpa ipsum quia laboriosam sit, minima inventore quam eaque, distinctio fugiat, cum voluptatum corporis explicabo voluptatem. Suscipit et incidunt in obcaecati illum tenetur culpa dolorum, veniam officiis laudantium a sequi ut blanditiis perferendis quibusdam, cum quam aperiam optio, pariatur unde aut reiciendis. Ipsa voluptate vitae expedita illum tenetur quos nulla, qui distinctio natus. Delectus magni similique dolor laudantium voluptates, omnis velit. Totam voluptatum, itaque fugit provident modi impedit quae illum perferendis sapiente, perspiciatis praesentium similique dolore quos laboriosam nulla necessitatibus deleniti asperiores dignissimos. Quaerat dolorem libero accusantium ducimus, id culpa magnam quisquam!
          </p>
        </div>
      </div>
